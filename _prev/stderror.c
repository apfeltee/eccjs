...
const eccobjinterntype_t ECCObjTypeError = {
...
{
    (void)parameterCount;
    io_libecc_Function.setupBuiltinObject(constructor, native, 1, prototype, ECCNSValue.error(nserrorfn_error(*name, NULL)), &ECCObjTypeError);
