...
const eccobjinterntype_t ECCObjTypeNumber = {
...
void setup()
{
    ...
    io_libecc_Function.setupBuiltinObject(&io_libecc_number_constructor, constructor, 1, &io_libecc_number_prototype, ECCNSValue.number(create(0)), &ECCObjTypeNumber);
