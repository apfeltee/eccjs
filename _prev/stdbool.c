...
const eccobjinterntype_t ECCObjTypeBoolean = {
...
void nsboolfn_setup()
{
    ...
    io_libecc_Function.setupBuiltinObject(&io_libecc_boolean_constructor, constructor, 1, &io_libecc_boolean_prototype, ECCNSValue.boolean(nsboolfn_create(0)), &ECCObjTypeBoolean);
