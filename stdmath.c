...
static
eccvalue_t mathAbs (eccstate_t * const context)
{
	eccvalue_t value;
...
static
eccvalue_t mathACos (eccstate_t * const context)
{
	eccvalue_t value;
...
static
eccvalue_t mathASin (eccstate_t * const context)
{
	eccvalue_t value;
...
static
eccvalue_t mathATan (eccstate_t * const context)
{
	eccvalue_t value;
...
static
eccvalue_t mathATan2 (eccstate_t * const context)
{
	eccvalue_t x, y;
...
static
eccvalue_t mathCeil (eccstate_t * const context)
{
	eccvalue_t value;
...
static
eccvalue_t mathCos (eccstate_t * const context)
{
	eccvalue_t value;
...
static
eccvalue_t mathExp (eccstate_t * const context)
{
	eccvalue_t value;
...
static
eccvalue_t mathFloor (eccstate_t * const context)
{
	eccvalue_t value;
...
static
eccvalue_t mathLog (eccstate_t * const context)
{
	eccvalue_t value;
...
static
eccvalue_t mathMax (eccstate_t * const context)
{
...
static
eccvalue_t mathMin (eccstate_t * const context)
{
	double result = INFINITY, value;
	int index, count;
...
static
eccvalue_t mathPow (eccstate_t * const context)
{
	eccvalue_t x, y;
...
static
eccvalue_t mathRandom (eccstate_t * const context)
{
	return ECCNSValue.binary((double)rand() / (double)RAND_MAX);
}

static
eccvalue_t mathRound (eccstate_t * const context)
{
	eccvalue_t value;
...
static
eccvalue_t mathSin (eccstate_t * const context)
{
	eccvalue_t value;
...
static
eccvalue_t mathSqrt (eccstate_t * const context)
{
	eccvalue_t value;
...
static
eccvalue_t mathTan (eccstate_t * const context)
{
	eccvalue_t value;
