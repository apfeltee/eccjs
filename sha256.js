    ...
    function core_sha256(m, l)
    {
        ...
        for (var i = 0; i < m.length; i += 16)
        {
            ...
            for (var j = 0; j < 64; j++)
            {
                ...
                {
                    tmp1 = safe_add(Gamma1256(wbuf[j - 2] || 0), wbuf[j - 7] || 0);
                    tmp2 = safe_add(tmp1, Gamma0256(wbuf[j - 15] || 0))
...
var s = "hello world";
var expect = 'b94d27b9934d3e08a52e52d7da7dabfac484efe37a5380ee9088f7ace2efcde9';
var h = SHA256(s);
println(((h == expect) ? 'ok' : 'fail'), ": '", s, "' => ", h)
