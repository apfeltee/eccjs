...
static void nsnumberfn_setup()
{
    ...
    ECCNSFunction.setupBuiltinObject(&ECC_CtorFunc_Number, objnumberfn_constructor, 1, &ECC_Prototype_Number, ecc_value_number(nsnumberfn_create(0)), &ECC_Type_Number);

    ECCNSFunction.addMember(ECC_CtorFunc_Number, "MAX_VALUE", ecc_value_binary(DBL_MAX), r | h | s);
    ECCNSFunction.addMember(ECC_CtorFunc_Number, "MIN_VALUE", ecc_value_binary(DBL_MIN * DBL_EPSILON), r | h | s);
    ECCNSFunction.addMember(ECC_CtorFunc_Number, "NaN", ecc_value_binary(NAN), r | h | s);
    ECCNSFunction.addMember(ECC_CtorFunc_Number, "NEGATIVE_INFINITY", ecc_value_binary(-INFINITY), r | h | s);
    ECCNSFunction.addMember(ECC_CtorFunc_Number, "POSITIVE_INFINITY", ecc_value_binary(INFINITY), r | h | s);
